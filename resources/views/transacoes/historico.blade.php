    ...
    <div class="card shadow-sm">
        ...
        <div class="card-body">
            ...
            @if($transacao->tipo === 'deposito')
                ...
                <p><strong>Chave da Carteira:</strong> {{ $transacao->carteira->chave }}</p>
            ...
            @elseif($transacao->tipo === 'transferencia')
                ...
                <p><strong>Chave:</strong> {{ $transacao->carteiraOrigem->chave }}</p>
                ...
                <p><strong>Chave:</strong> {{ $transacao->carteiraDestino->chave }}</p>
